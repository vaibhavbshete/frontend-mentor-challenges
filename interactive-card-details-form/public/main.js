...
(0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)({
  ...
  computed: {
    cardNumberWithSpaces: {
      get: function get() {
        var cardNum = this.card.number.value; // console.log(parseInt(cardNum));
        // if (isNaN(cardNum)) {
        //     return cardNum;
        // }

        var wspaces = this.cardNum.replace(/\s*/g, '').matchAll(/\d{1,4}/g);
      ...
      set: function set(value) {
        var cardNumWOSpaces = value.replace(/\s*/g, ''); // if (!parseInt(cardNumWOSpaces)) {
  ...
  methods: {
    onCardNumInput: function onCardNumInput(event) {
      // console.log(event);
      var cardInputTxt = event.target;
      var cardNum = this.card.number.value; // console.log(parseInt(cardNum));

      cardNum = cardNum.replace(/\s*/g, ''); // validate
      // if (isNaN(cardNum)) {
      ...
      var wspaces = cardNum.matchAll(/.{1,4}/g);
      wspaces = Array.from(wspaces).join(' ');
    ...
    validate: function validate(item, itemkey) {
      var activeCheck = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      // let items;
      ...
      if (item.error !== "") {
        this.formHasErrors = true; // console.log(this.formHasErrors);
      } // })
    ...
    onSubmit: function onSubmit() {
      ...
      for (var _i = 0, _Object$entries = Object.entries(this.card); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
            key = _Object$entries$_i[0],
            value = _Object$entries$_i[1];

        // console.log(key);
        this.validate(value, key, true); // value.error = "Error hai "+key+" ka bhaiya!";
        // console.log(value);
      }
    ...
    validations: function validations() {
      return {
        ...
        number: function number(numberTxt, submitCheck) {
          var errMsg = "";
          var numSansSpaces = numberTxt.value.replaceAll(/\s*/g, '');
        ...
        cvc: function cvc(_cvc, submitCheck) {
          // console.log(this);
          if (isNaN(_cvc.value)) {
            return "Only numbers allowed";
          }

          if (_cvc.value.length != 3 && submitCheck) {
            return "Only 3 digits allowed";
          } else return '';
        },
        expDate: function expDate(dateObj) {
          var errMsg = ""; // console.log(dateObj);x

          if (isNaN(dateObj.month.value) || isNaN(dateObj.year.value)) {
            errMsg += "Only numbers allowed"; // return errMsg;
          }

          if (dateObj.month.value > 12 || dateObj.month.value < 1) {
            errMsg += "Month should be in 1-12 range"; // return errMsg;
          }
    ...
    leadZero: function leadZero(valueObj) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkinteractive_card_details_form"] = self["webpackChunkinteractive_card_details_form"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["main"], () => (__webpack_require__("./src/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["main"], () => (__webpack_require__("./src/main.css")))
